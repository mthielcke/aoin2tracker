    ...
    blocks: [
      {
        ...
        rows: [
          ['Einstieg', 'Kro Cave, Draupnir Cave (Conquest)', 'niedrig, Draupnir Conquest ca. 700', 'aLuckyRO'],
          ['Wöchentlich', 'Ascension Trial', '1.000 leicht · 1.500 normal · 2.000 schwer', 'DankRNG, aLuckyRO'],
          ['Mitte', 'Urugugu Canyon (Waffe, Accessoires), Vakron Sky Island (Rüstung, Guard)', '1.500–1.600; Vakron ab ca. 1.800', 'Society of Gaming, Sen'],
          ['Arcana', 'Transcendence', '1.600–1.800', 'Sen, Koodoki'],
          ['3★', 'Fire Temple (Extend-Waffe), Horn Den', '2.100–2.200; laut Sen 2.400', 'Society of Gaming, Koodoki, Sen'],
          ['Top', 'Sanctuary-Raid (10 Spieler)', 'ca. 2.800', 'Koodoki'],
        ],
      },
      {
        type: 'callout',
        variant: 'warning',
        title: 'Nur Richtwerte',
        text: 'Die Zahlen stammen aus KR/TW und dem Launch Scale Test. Für Global werden etwas niedrigere Anforderungen erwartet (z. B. 1.500 statt 1.600, 2.100 statt 2.200) – im Spiel prüfen.',
      },
      {
        type: 'steps',
